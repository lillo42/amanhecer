...
/// </summary>
public class DekafSubscriptionConfigurator
{
    ...
    public DekafSubscriptionConfigurator Name(string name)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator ToRoutingKey(string routingKey)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator Topic(string topic)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator GroupId(string groupId)
    {
    ...
    private global::Dekaf.Consumer.AutoOffsetReset _autoOffsetReset = global::Dekaf.Consumer.AutoOffsetReset.Earliest;
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator AutoOffsetReset(AutoOffsetReset autoOffsetReset)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator CommitBatchSize(long commitBatchSize)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator SweepUncommittedOffsetsInterval(TimeSpan interval)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator MessageMapper(
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
        Type mapper)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator NumberOfConsumers(int numberOfConsumers)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator DefaultSpecVersion(string specVersion)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator DefaultSource(Uri source)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator DefaultType(string type)
    {
        _defaultType = type;
        return this;
    }
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator DeadLetterQueueRoutingKey(string routingKey)
    {
        if (string.IsNullOrEmpty(routingKey))
        {
            throw new ArgumentException("Routing key cannot be null or empty.", nameof(routingKey));
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator InvalidMessageRoutingKey(string routingKey)
    {
        if (string.IsNullOrEmpty(routingKey))
        {
            throw new ArgumentException("Routing key cannot be null or empty.", nameof(routingKey));
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator CloudEvent(CloudEventType cloudEvent)
    {
    ...
    /// </summary>
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator JsonCloudEvent()
    {
    ...
    /// </summary>
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator BinaryCloudEvent()
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator OnError(Func<Message, Exception, IConsumerAction> onError)
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator Provisioner(ISubscriptionProvisioner provisioner)
    {
    ...
    /// </summary>
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator AssumeExists()
    {
    ...
    /// </summary>
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator ValidateIfExists()
    {
    ...
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator CreateIfNotExists(Action<CreateTopicConfigurator> configure)
    {
    ...
    /// </summary>
    /// <returns>The configurator instance for method chaining.</returns>
    public DekafSubscriptionConfigurator CreateIfNotExists()
    {
        _provisioner = new CreateTopic();
        return this;
    }

    internal DekafSubscription ToSubscription()
    {
        ...
        var subscription = new DekafSubscription(_toRoutingKey!,

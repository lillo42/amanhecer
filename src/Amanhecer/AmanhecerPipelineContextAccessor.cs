...
/// <see cref="AmanhecerContext"/> in an <see cref="AsyncLocal{T}"/>, so it flows with the
/// asynchronous execution context.
/// </summary>
public class AmanhecerPipelineContextAccessor : IPipelineContextAccessor
{
    private readonly AsyncLocal<AmanhecerContext?> _accessor = new();

    /// <inheritdoc cref="IPipelineContextAccessor.PipelineContext"/>
    public AmanhecerContext? PipelineContext
    {
        get => _accessor.Value;

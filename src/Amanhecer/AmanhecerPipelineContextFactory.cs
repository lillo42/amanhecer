...
public class AmanhecerPipelineContextFactory(IExecutingStrategy defaultStrategy) : IPipelineContextFactory
{
    ...
    {
        return new AmanhecerPipelineContext(context.Activity, 

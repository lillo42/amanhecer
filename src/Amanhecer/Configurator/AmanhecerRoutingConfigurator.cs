...
public class AmanhecerRoutingConfigurator(string routingKey, IServiceCollection services)
{
    private Type? _handlerType;
    private readonly List<AmanhecerMiddlewareOptions> _middlewareOption = [];
    ...
    /// <returns>The current <see cref="AmanhecerRoutingConfigurator"/>, for chaining.</returns>
    public AmanhecerRoutingConfigurator UseHandler<
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors |

...
/// <summary>
/// Declares <see cref="AmanhencerLoggerMiddleware"/> on the annotated handler class or
...
public class RequestLoggingAttribute(int order) : MiddlewareAttribute(order)
{
    ...
    {
        return typeof(AmanhencerLoggerMiddleware);
    }
}
...
public partial class AmanhencerLoggerMiddleware(ILogger<AmanhencerLoggerMiddleware> logger) : IMiddleware
{
    /// <inheritdoc />

...
[InheritsTests]
public class ConfluentKafkaMessagingGateway2Tests : MessagingGateway2Tests<ConfluentKafkaGateway>
{
    protected override TimeSpan MessagePropagateDelay => TimeSpan.FromSeconds(5);

    protected override ConfluentKafkaGateway CreateGateway()
    {
        ...
        string? routingKey = null)
    {
        ...
        return new ConfluentKafkaSubscription(

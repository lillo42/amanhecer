...
public class AmanhecerPipelineContextFactoryTests
{
    private readonly IExecutingStrategy _executingStrategy;
    private readonly AmanhecerPipelineContextFactory _factory;

    public AmanhecerPipelineContextFactoryTests()
    {
        _executingStrategy = Substitute.For<IExecutingStrategy>();
        _factory = new AmanhecerPipelineContextFactory(_executingStrategy);
    }

    [Test]
    [Arguments(typeof(SomeRequest), null, "Amanhecer.Tests.AmanhecerPipelineContextFactoryTests+SomeRequest")]

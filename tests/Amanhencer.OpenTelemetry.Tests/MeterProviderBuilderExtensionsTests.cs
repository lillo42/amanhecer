...
public class MeterProviderBuilderExtensionsTests
{
    ...
    [Test]
    public async Task AddAmanhencerInstrumentation_DispatchedRequest_ExportsSuccessCounterAndDurationHistogram()
    {
        ...
        await Assert.That(success!.MeterName).IsEqualTo(AmanhencerDiagnostics.InstrumentationName);
    ...
    [Test]
    public async Task AddAmanhencerInstrumentation_FailedRequest_ExportsFailedCounter()
    {
    ...
    [Test]
    public async Task AddAmanhencerInstrumentation_InstrumentFromOtherMeter_IsNotCaptured()
    {
        var exported = new List<Metric>();
        using var provider = Sdk.CreateMeterProviderBuilder()
            .AddAmanhencerInstrumentation()
